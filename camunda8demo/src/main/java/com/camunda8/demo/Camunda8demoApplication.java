...
@Deployment(resources = {"emailConnectorGmail.bpmn", "adHocSubprocess.bpmn", "Onboarding.bpmn", "compensateTask.bpmn", "offboarding_form.form", "inputForm.form", "bankAccountForm.form","multi-instance.bpmn","TechStackDMN.dmn"})
